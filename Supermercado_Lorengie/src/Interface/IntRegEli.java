...
public class IntRegEli extends javax.swing.JFrame {
    ...
    /**
     * Set index Employee
     * @param indexemployee index employee   
     */
            ...
            .addGroup(pnlInter4Layout.createSequentialGroup()
                ...
                .addGroup(pnlInter4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(pnlInter4Layout.createSequentialGroup()
                        ...
                        .addGroup(pnlInter4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lblIdEmp)
                            .addComponent(txtEmployeeIdentification, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(21, 21, 21)
                        .addGroup(pnlInter4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(lblUser)
...
//        String auxPass = new String(arrayChar); 
        employee.setPassword(new String(jpfPassword.getPassword()));
        employee.setEmail(txtEmail.getText());
        return employee;
    }
    
    /**
     * Method interface to object 2 
     * @return employee object 
     */
...
//        String auxPass = new String(arrayChar); 
    ...
    private void addTable() {
        ...
        try {
            ...
            while(dataFile.getResultSet().next()) {
                ...
                object[6] = dataFile.getResultSet().getString("email");
    ...
    private void insertEmployee() {
        ...
        String query = "INSERT INTO Employee"
                + "(employeeCode, employeeName, employeeIdentification, employeePosition, userName, password,email)"
                + "VALUES ("
     ...
     */
     private void object2View() {
        ...
        try {
            ...
            employee.setEmail(this.getDataFile().getResultSet().getString("email"));
     ...
     /**
      * Recursive method object to view 
      * @param employee 
      */
