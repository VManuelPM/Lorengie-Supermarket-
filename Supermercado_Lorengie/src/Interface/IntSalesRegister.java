...
public class IntSalesRegister extends javax.swing.JFrame {
    ...
    /**
     * Creates new form IntSalesRegister 
     */
    ...
    private void btnSeeBillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeeBillActionPerformed
        if(txtQuantityProd.getText().equals("") || txtSalePrice.getText().equals("")) {
            ...
            openIntBill.setProductName(this.jcbProductName.getSelectedItem().toString());
            openIntBill.setProductQuantity(Integer.parseInt(this.txtQuantityProd.getText()));
            openIntBill.setVisible(true);
            openIntBill.setLocationRelativeTo(null);
        }
    ...
    private boolean validateView(){
     ...
     /**
      * Method insert product to see bill
      */
